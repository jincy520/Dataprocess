...
public class uploadprocessingtrain {
	...
	public static void main(String[] args) throws IOException {
		...
		String path=args[0]; //gold files
		String path1=args[2];// output data file
		String path2=args[1];// output lable file
		String path3=args[4];// word.txt 
		uploadProcessingTrain wor=new uploadProcessingTrain();
